 ...
 * this array can represent a square, cubic, or hypercubic plane of arbitrary size.
 * Ex: a cube (l = 3) would be represented by an array of length 27 (3 ^ 3).
...
// returns the point that intersects with the origin of {ax} axis
...
const segment = function (ax, point, upperBound, lowerBound) {
...
const region = function * (coord, dimension) {
  ...
  for (let n of segment(dimension, coord, 1, -1)) {
